...
És a dir, en aquest cas els modes ràpids i lents són idèntics als modes d'una corda en la que les ones es propaguen amb velocitat $v_A(x)$ i $c_s(x)$ de l'Eq.~(\ref{eq.3.34}), respectivament.
