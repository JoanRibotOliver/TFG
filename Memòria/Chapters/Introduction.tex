...
Per veure una imatge real d'una protuberància solar es pot consultar l'Apèndix~\ref{ap.A}.
...
\begin{figure}[H]
    ...
    (b) Diagrama del sistema en equilibri tèrmic, com a làmina plana paral·lela damunt la superfície amb dimensions de $2x_p$ de gruix en direcció $\hat{x}$,
...
A més, s'ha de definir el sistema en equilibri termodinàmic i estàtic, per després pertorbar-lo lleugerament i comprovar la propagació d'aquesta pertorbació com a ona dins la protuberància i el medi.
S'ignoren els efectes gravitatoris i dissipatius del plasma, com la viscositat i la difusió magnètica.
