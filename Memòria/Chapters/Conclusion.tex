...
En el cas dels modes ràpids, l'autofunció no dominant, $\tilde{v}_{x}$, és aquella que presenta una direcció paral·lela al camp magnètic del sistema, $\bm{B}$,
mentre que l'autofunció dominant, $v_z$, és perpendicular al camp i paral·lel al nombre d'ona o constant d'acoblament, $k_z$.
Aquests sempre presenten paritats oposades, com s'ha demostrat en les diferents figures del treball.
Els modes lents en canvi, demostren un comportament oposat. Les seves autofuncions no dominants, $v_z$, són paral·lels a l'acoblament,
mentre que les predominants, $\tilde{v}_{x}$, són aquelles perpendiculars al vector d'ona i paral·lels al camp.

S'ha demostrat el canvi de dominància de les autofuncions en el sí d'un encreuament d'un mode a un altre.
...
mentre que els ràpids en pateixen les conseqüències de manera més notable, tant en l'autofunció dominant com en la no dominant.
...
D'aquesta manera, tant les Eqs.~(\ref{eq.3.21})~i~(\ref{eq.3.23}) com les Eqs.~(\ref{eq.3.30}),~(\ref{eq.3.31})~i~(\ref{eq.3.32}) estan compostes per termes extres tals que lliguen dites equacions.
