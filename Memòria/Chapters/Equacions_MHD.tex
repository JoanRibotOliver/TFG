...
En aquesta secció es donen les directrius principals de la deducció de les equacions MHD ideals.
...
Per aquest motiu, l'Eq.~(\ref{eq.2.1}) es simplifica amb $c \rightarrow \infty$.
...
Per aquest motiu es pot considerar una resistivitat del medi, $\sigma$,
infinita, llavors el terme $\bm{j}/\sigma$ desapareix de l'Eq.~(\ref{eq.2.6}).
En aquest cas és possible fer l'assumpció de resistivitat infinita ja que les escales de longitud del problema són grans.
...
Les variables més importants en un plasma són el camp magnètic, $\bm{B}$, i la velocitat del propi plasma, $\bm{v}$,
i per tant,és convenient escriure totes les expressions en funció d'aquestes.
...
En aquest treball es considera un plasma d'hidrògen totalment ionitzat, pel qual $m = m_p/2$, llavors $\tilde{\mu} = 0.5$.
...
Així doncs, de l'equació de calor s'obté una condició que es fa servir al resoldre les equacions linealitzades en la Sec.(\ref{sec:onesMHD}).
...
\begin{enumerate}[label=\Roman*.]
	...
	\item \label{punt:VI} Plasma fluid únic, tot i que existeixen models de plasmes de 2 fluids, de 3 fluids i fins i tot de multifluids.
